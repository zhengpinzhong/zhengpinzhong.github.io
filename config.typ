...
#let template = tufted.tufted-web.with(
  ...
  website-title: "Pinzhong Zheng",
  /// 网站作者。用于生成 <meta name="author"> 标签。（可选）
  author: "@zhengpinzhong",
  /// 网站描述。用于 SEO 搜索引擎摘要和社交媒体分享预览。（可选）
  description: "Pinzhong Zheng's Personal Website, Powered by Typst",
  /// 站点的根 URL (例如 "https://example.com")。用于生成 Canonical URL 元数据。（可选）
  website-url: "https://zhengpinzhong.github.io",
  ...
  footer-elements: (
    "© 2026 Yousa-Mirage © 2026 Pinzhong Zheng.",
